          ...
          <div>
            ...
            <div className="container border-2">
              <Img
                ...
                alt={page.properties.title.title[0].plain_text}
                maxHeight={70}
                className="rounded-full w-[70px] left-10 -top-9"
              />
            </div>
          </div>
        )}
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 bg-white -mt-20">
          <div
            className={
              "prose lg:prose-xl pt-32 pb-12  mx-auto max-w-2xl text-center"
            }
          >
            {blocks.map((block, i) => (
